...
from build_template import bib_from_tmpl, html_from_tmpl
from conf import bib_dir, html_dir, pdf_dir, static_dir
...
proc_dict.update(
    {"pdf": "pdfs/proceedings.pdf", "bibtex": "bib/" + citation_key + ".bib"}
)
