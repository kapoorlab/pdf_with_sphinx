...
from tempita.compat3 import basestring_, bytes, coerce_text, is_unicode, next
...
def lex(s, name=None, trim_whitespace=True, line_offset=0, delimeters=None):
    ...
    last_pos = (1, 1)
    token_re = re.compile(
        r"{}|{}".format(re.escape(delimeters[0]), re.escape(delimeters[1]))
    )
...
def fill_command(args=None):
    ...
    if template_name == "-":
        ...
        with open(template_name, mode="rb") as f:
